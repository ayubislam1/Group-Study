...
const CreateAssignmentPage = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-8 p-6 bg-transparent dark:bg-transparent dark:border dark:text-white rounded-lg shadow-md">
      {/* Top Banner */}
      <div className="bg-blue-500 text-white p-4 mb-6 rounded-lg shadow-md">
        <h1 className="text-3xl font-bold text-center">Create New Assignment</h1>
      </div>
        ...
        <div className="mb-4">
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button variant="outline" className="w-full text-left bg-transparent border border-gray-600 dark:text-white">
